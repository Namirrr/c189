AFRAME.registerComponent("obstacle", {
  init: function () {
    ...
    for (var i = 0; i < 10; i++) {
      ...
      //set the position
      obstacles.setAttribute("position", { x: posX, y: 1.5, z: -35 });
      obstacles2.setAttribute("position", { x: posX, y: 1.5, z: 85 });
      obstacles3.setAttribute("position", { x: -30, y: 1.5, z: posZ });
      obstacles4.setAttribute("position", { x: 50, y: 1.5, z: posZ });
